...
const ListingClient = ({
    ...
    // Disable the date range based on the dates that are already reserved.
    ...
    // Update and store the selected date range through api call post request
    ...
    // Set up the listing price based on the date range
    useEffect(() => {
